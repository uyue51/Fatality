...
namespace evo::gui
{
	...
	struct color_list
	{
		MAKE_COLOR(accent, 194, 103, 118);
		MAKE_COLOR(text, 245, 245, 245);
		MAKE_COLOR(text_light, 245, 245, 245);
		MAKE_COLOR(text_mid, 109, 109, 109);
		MAKE_COLOR(text_dark, 109, 109, 109);
		MAKE_COLOR(bg_bottom, 21, 21, 21);
		MAKE_COLOR(bg_block, 28, 28, 28);
		MAKE_COLOR(bg_block_overlay, 21, 21, 21);
		MAKE_COLOR(bg_block_light, 20, 20, 20);
		MAKE_COLOR(bg_odd, 28, 28, 28);
		MAKE_COLOR(bg_even, 28, 28, 28);
		MAKE_COLOR(outline, 37, 37, 37);
		MAKE_COLOR(outline_light, 60, 53, 93);
		MAKE_COLOR(warning, 245, 236, 66);
		MAKE_COLOR(danger, 245, 66, 66);
		MAKE_COLOR(success, 143, 255, 102);
		MAKE_COLOR(text_orange, 222, 135, 56); 
	};

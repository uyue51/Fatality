...
context::context(float text_size)
{
	...
	draw.fonts[GUI_HASH("gui_main")] = std::make_shared<font>((win_dir + XOR("/fonts/seguisb.ttf")).c_str(), 16.f, 0, 0, 0x45F);
	draw.fonts[GUI_HASH("gui_bold")] = std::make_shared<font>((win_dir + XOR("/fonts/verdanab.ttf")).c_str(), 14.f, 0, 0, 0x45F);

...
// Macro to hash a string using the evo::gui::hash function
#define GUI_HASH(s) evo::gui::hash(s)

// Macro to hash a string to a 32-bit integer using the evo::gui::hash_32 function
#define GUI_HASH_32(s) evo::gui::hash_32(s)

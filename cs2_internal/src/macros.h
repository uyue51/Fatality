...
public:
	template <size_t... s>
	constexpr __forceinline xorstr_simple(const char *str, std::index_sequence<s...>) :
...
#define ENC_KEY(s) xorstr_simple<sizeof(s) - 1, __COUNTER__>(s, std::make_index_sequence<sizeof(s) - 1>())
